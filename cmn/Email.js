...
email.directive("emailTo", function() {
  return {
    ...
    template: '<div class="multiEmail"><span>To: </span><span ng-repeat="recip in recipients">'+
        ...
        ', </span>'+
        '<input ng-model="nextRecip" ng-on-blur="addRecip(nextRecip)" ui-keypress="{enter: \'addRecip(nextRecip)\'}" type="text" typeahead="state for state in states | filter:$viewValue" typeahead-min-length="0"/></span></div>',
