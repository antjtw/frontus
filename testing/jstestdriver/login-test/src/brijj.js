...
(function() {  var _ = window; if (_.SWBrijj == undefined) {
    var p;p = {}; p._path = '/brijj';
p.activate = function(p0, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'activate', arguments); };
p.betaLogin = function(p0, p1, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'betaLogin', arguments); };
p.companyFormFillout = function(p0, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'companyFormFillout', arguments); };
p.companyPreregister = function(p0, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'companyPreregister', arguments); };
p.forgot = function(p0, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'forgot', arguments); };
p.formFillout = function(p0, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'formFillout', arguments); };
p.getProfile = function(callback) {
  return brijj._execute(p._path, 'SWBrijj', 'getProfile', arguments); };
p.getSignups = function(callback) {
  return brijj._execute(p._path, 'SWBrijj', 'getSignups', arguments); };
p.hello = function(p0, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'hello', arguments); };
p.login = function(p0, p1, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'login', arguments); };
p.logout = function(callback) {
  return brijj._execute(p._path, 'SWBrijj', 'logout', arguments); };
p.proc = function(p0, p1, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'proc', arguments); };
p.procd = function(p0, p1, p2, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'procd', arguments); };
p.procm = function(p0, p1, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'procm', arguments); };
p.registerCompany = function(p0, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'registerCompany', arguments); };
p.registerInvestors = function(p0, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'registerInvestors', arguments); };
p.registration = function(p0, p1, p2, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'registration', arguments); };
p.resetFillout = function(p0, callback) {
...
p.uploadImage = function(p0, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'uploadImage', arguments); };
p.uploadImage = function(p0, callback) {
  return brijj._execute(p._path, 'SWBrijj', 'uploadImage', arguments); };
