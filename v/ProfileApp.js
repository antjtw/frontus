...
app.config(function($routeProvider){
  $routeProvider.
      when('/contact', {controller:ContactCtrl, templateUrl:'v/contact.html'}).
      when('/social', {controller:SocialCtrl, templateUrl:'v/social.html'}).
      when('/password', {controller:PasswordCtrl, templateUrl: 'v/password.html'}).
      when('/photo', {controller:PhotoCtrl, templateUrl: 'v/photo.html'}).
...
function initPage($scope, x) {
  ...
  $scope.$apply();
	...
	function initFail(x) {
		document.location.href='u/index.html';
	}
