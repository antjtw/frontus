...
function Browser(window, document, $log, $sniffer) {
  ...
  var baseElement = window.document.getElementsByTagName('base');
  baseElement = baseElement.length > 0 ? baseElement[0] : undefined;
    ...
    if (url) {
      ...
      if ($sniffer.history) {
        if (replace) history.replaceState(null, '', url);
          ...
          // baseElement.href = baseElement.href;
        }
      } else {
  ...
  self.baseHref = function() {
      var href = baseElement ? baseElement.href : window.document.location.href;
